...
5. **LLM generation** — call Groq models (`llama-3.1-8b-instant` preferred) with retrieved context + prompt to produce English translation/answer.  
6. **Fallbacks** — if Groq models are unavailable, the system returns retrieved context snippets rather than failing silently.
# tanaka